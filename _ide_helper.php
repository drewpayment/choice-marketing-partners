...
namespace Meneses\LaravelMpdf\Facades { 
    ...
    class LaravelMpdf {
         ...
         *
         * @param string $html
         * @return \Meneses\LaravelMpdf\Pdf 
         * @static 
         */ 
        public static function loadHTML($html, $config = array())
        {
            return \Meneses\LaravelMpdf\LaravelMpdfWrapper::loadHTML($html, $config);
        }
        ...
        {
            return \Meneses\LaravelMpdf\LaravelMpdfWrapper::loadFile($file, $config);
        }
        ...
        {
            return \Meneses\LaravelMpdf\LaravelMpdfWrapper::loadView($view, $data, $mergeData, $config);
        }
